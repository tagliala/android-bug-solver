...
Device.create! name: 'Nexus 5X',                released_at: '2015-09-29', scapegoats: %w(Qualcomm ARM Corning LGE)
Device.create! name: 'Nexus 6P',                released_at: '2015-09-29', scapegoats: %w(Qualcomm ARM Corning Huawei)
Device.create! name: 'Pixel',                   released_at: '2016-10-04', scapegoats: %w(Qualcomm ARM Corning HTC)
Device.create! name: 'Pixel XL',                released_at: '2016-10-04', scapegoats: %w(Qualcomm ARM Corning HTC)
